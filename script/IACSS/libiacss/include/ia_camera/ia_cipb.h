...
typedef ia_err_t (*populate_cb)(ia_cipf_registry_t*);
...
ia_cipb_t ia_cipb_create(void);
  ...
  * \ingroup ia_camera
  */
ia_err_t ia_cipb_destroy(ia_cipb_t ipb);
 ...
 */
ia_cipf_pipe_t* ia_cipb_create_pipeline(ia_cipb_t ipb, ia_cipb_graph_t graph);
 ...
 */
ia_err_t ia_cipb_register_cipf_library(ia_cipb_t ipb, populate_cb populate);
