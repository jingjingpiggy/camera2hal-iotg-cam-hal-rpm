...
typedef ia_err_t (*terminal_buffer_op)(ia_cipf_terminal_t*, ia_cipf_buffer_t*);
typedef ia_err_t (*terminal_buffer_ref_op)(ia_cipf_terminal_t*, ia_cipf_buffer_t**);
typedef ia_err_t (*terminal_set_format_op)(ia_cipf_terminal_t*, const ia_cipf_frame_format_t*);
typedef ia_err_t (*terminal_get_format_op)(ia_cipf_terminal_t*, ia_cipf_frame_format_t*);
typedef ia_err_t (*terminal_set_property_op)(ia_cipf_terminal_t*, ia_uid uid, const ia_cipf_property_t*);
typedef ia_err_t (*terminal_get_property_op)(ia_cipf_terminal_t*, ia_uid uid, ia_cipf_property_t*);
