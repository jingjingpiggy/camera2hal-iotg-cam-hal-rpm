 ...
 */
typedef ia_err_t (*stage_op)(ia_cipf_stage_t*);
typedef ia_err_t (*stage_set_property_op)(struct _cipf_stage*,
                                          ia_uid uid,
                                          const ia_cipf_property_t *);
typedef ia_err_t (*stage_get_property_op)(struct _cipf_stage*,
                                          ia_uid uid,
                                          ia_cipf_property_t *);
