...
struct _cipf_stage {
    ...
    uint32_t            iteration;
    ia_err_t            (*load)(struct _cipf_stage*);
    ia_err_t            (*execute)(struct _cipf_stage*);
    ia_err_t            (*wait)(struct _cipf_stage*);
    ia_err_t            (*destroy)(struct _cipf_stage*);
    ia_err_t            (*set_property)(struct _cipf_stage*,
                                        ia_uid uid,
                                        const ia_cipf_property_t *);
    ia_err_t            (*get_property)(struct _cipf_stage*,
                                        ia_uid uid,
                                        ia_cipf_property_t *);
    log_context_t       *context;
};

typedef ia_err_t (*container_set_property_op)(struct _cipf_container*,
                                              ia_uid uid,
                                              const ia_cipf_property_t *);
typedef ia_err_t (*container_get_property_op)(struct _cipf_container*,
                                              ia_uid uid,
                                              ia_cipf_property_t *);
